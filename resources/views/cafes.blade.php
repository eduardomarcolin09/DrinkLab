...
<body class="bg-gray-50 font-sans">
    ...
    <section class="container mx-auto px-6 py-12">
        <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">Explore Nossos Cafés</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-500">
                ...
                <div class="p-4">
                    <h3 class="text-xl font-semibold text-gray-800">{{ $cafe['title'] }}</h3>
                    <p class="text-gray-600 mt-2 text-sm">{{ $cafe['description'] }}</p>
