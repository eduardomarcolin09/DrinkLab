            ...
            <div class="p-6">
                ...
                <form action="{{ route('register') }}" method="POST" class="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" required class="w-full mt-1 p-3 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" placeholder="Digite seu nome" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" required class="w-full mt-1 p-3 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" placeholder="exemplo@email.com" value="{{ old('email') }}">
                        @error('email')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" required class="w-full mt-1 p-3 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" placeholder="********">
                        @error('password')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Confirme a
                            Senha</label>
                        <input type="password" id="password_confirmation" name="password_confirmation" required class="w-full mt-1 p-3 border rounded-md focus:outline-none focus:ring focus:ring-blue-300" placeholder="********">
                    </div>
                    <!-- Botão -->
